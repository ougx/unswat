...
REAL, DIMENSION(5,3) :: btn = reshape ((/20.2, 0.825, 1.070, 0.479, 1.258,  &
    4.04, 0.936, 0.937, 0.692, 1.373, 1.66, 0.703, 0.465, 0.521, 1.845/), (/5,3/))
REAL, DIMENSION(5,3) :: btp = reshape ((/1.725, 0.884, 0.826, 0.467, 2.130,  &
