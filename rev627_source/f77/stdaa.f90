...
IF (iscen == 1) THEN
  WRITE (26,2200) wshd_wstrs, wshd_tstrs, wshd_nstrs, wshd_pstrs, wshd_astrs
ELSE IF (isproj == 1) THEN
  WRITE (19,2200) wshd_wstrs, wshd_tstrs, wshd_nstrs, wshd_pstrs, wshd_astrs
END IF
...
IF (iscen == 1) THEN
  ...
  WRITE (26,2300) wshdaao(1), wshdaao(39), wshdaao(36), wshdaao(37),  &
      ...
      wshdaao(5), wshdaao(7), wshdaao(108), wshdaao(38), wshd_sepmm,  wshdaao(12)
...
ELSE IF (isproj == 1) THEN
  ...
  WRITE (19,2300) wshdaao(1), wshdaao(39), wshdaao(36), wshdaao(37),  &
      wshdaao(3), wshdaao(4),wshdaao(109),wshdaao(104),wshdaao(113),  &
      wshdaao(105), wshdaao(106), wshdaao(107), wshdaao(6),  &
      wshdaao(5), wshdaao(7), wshdaao(108), wshdaao(38), wshdaao(12)
...
IF (iscen == 1) THEN
  ...
  WRITE (26,2700)wshdaao(40), wshdaao(41), wshdaao(42), wshdaao(45),  &
      ...
      wshdaao(43), wshdaao(46), wshd_plch, wshdaao(44), wshd_pup, wshdaao(110)
...
ELSE IF (isproj == 1) THEN
  ...
  WRITE (19,2700) wshdaao(40), wshdaao(41), wshdaao(42),  &
      ...
      wshdaao(46), wshd_plch, wshdaao(44), wshd_pup, wshdaao(110)
...
WRITE (26,3101) wshd_sepno3, wshd_sepnh3, wshd_seporgn,  &
    wshd_sepfon, wshd_seporgp, wshd_sepfop, wshd_sepsolp, wshd_sepbod
...
3101  FORMAT (t20,'NITRATE SEPTIC = ',f12.2,' (kg/ha)',/,t20,  &
    ...
    'SOL P SEPTIC = 'f12.2,' (kg/ha)',/,t20, 'BOD SEPTIC = ',f12.2,' (kg/ha)')
...
1300 FORMAT (//t21,'IRRIGATION - AVE. ANNUAL',/,t14,'HRU',t27,  &
    'NO.OF ',t44,'VOLUME',/,t14,'NO.',t24,'APPLICATIONS',t42, 'APPLIED(MM)',/)
...
1800 FORMAT (3X,'HRU',t8,' SUB',t14,'SOIL',t25,'AREAkm2', t36,'CN',  &
...
2200 FORMAT (/,t5,' AVE ANNUAL BASIN STRESS DAYS',/,t15,  &
    ...
    ' PHOSPHORUS STRESS DAYS = ',f8.2,/,t15, ' AERATION STRESS DAYS = ',f8.2)
2300 FORMAT (t10,'AVE ANNUAL BASIN VALUES'// t15,'PRECIP = ',f8.1,' MM'/  &
    t15,'SNOW FALL =',f8.2,' MM'/ t15,'SNOW MELT = ',f8.2,' MM'/  &
    t15,'SUBLIMATION = ',f8.2,' MM'/ t15,'SURFACE RUNOFF Q = ',f8.2,' MM'/  &
    t15,'LATERAL SOIL Q =',f8.2,' MM'/ t15,'TILE Q = ',f8.2,' MM'/  &
    t15,'GROUNDWATER (SHAL AQ) Q = ',f8.2,' MM'/  &
    t15,'GROUNDWATER (DEEP AQ) Q = ',f8.2,' MM'/  &
    t15,'REVAP (SHAL AQ => SOIL/PLANTS) =',f8.2,' MM'/  &
    t15,'DEEP AQ RECHARGE = ',f8.2,' MM'/ t15,'TOTAL AQ RECHARGE =',f8.2,' MM'/  &
    t15,'TOTAL WATER YLD = ',f8.2,' MM'/  &
    t15,'PERCOLATION OUT OF SOIL =',f8.2,' MM'/ t15,'ET = ',f8.1,' MM'/  &
    t15,'PET = ',f8.1,'MM'/ t15,'TRANSMISSION LOSSES = ',f8.2,' MM'/  &
...
2800 FORMAT (t20,'ACTIVE TO SOLUTION P FLOW =  ',f12.3,' (KG/HA)',/,t20  &
    ...
    'N FIXATION = ',f9.3,' (KG/HA)',/,t20,'DENITRIFICATION = ',f9 .3,' (KG/HA)')
