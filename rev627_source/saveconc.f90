...
!! Convert the unit of "hhvaroute" from "m3/dt" to "m3/sec" where dt in minute
    ...
    DO ii = 1, nstep
      ...
      IF (hhvaroute(2,ihout,ii) > 0.001) THEN
        ...
        varii(3) = hhvaroute(4,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(4) = hhvaroute(5,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(5) = hhvaroute(6,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(6) = hhvaroute(14,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(7) = hhvaroute(15,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(8) = hhvaroute(7,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(9) = hhvaroute(16,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(10) = hhvaroute(17,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(11) = hhvaroute(13,ihout,ii) * 1.e6 / hhvaroute(2,ihout,ii)
        varii(12) = hhvaroute(11,ihout,ii) / (1000. * hhvaroute(2,ihout,ii))
        varii(13) = hhvaroute(12,ihout,ii) / (1000. * hhvaroute(2,ihout,ii))
        varii(14) = hhvaroute(18,ihout,ii) / (1000. * hhvaroute(2,ihout,ii))
        varii(15) = hhvaroute(19,ihout,ii) / (1000. * hhvaroute(2,ihout,ii))
        varii(16) = hhvaroute(20,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(17) = hhvaroute(21,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
        varii(18) = hhvaroute(22,ihout,ii) * 1000. / hhvaroute(2,ihout,ii)
