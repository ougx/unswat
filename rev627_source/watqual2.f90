...
!       write(104, *) o2con, 'o'
  o2con2=o2con
  IF (o2con2 <= 0.1) o2con2=0.1
  IF (o2con2 > 30.) o2con2=30.
...
IF(rchdep > 0.001) xx = theta(rk4(jrch),thrk4,wtmp) / (rchdep * 1000.)
IF (nh3con > 0.001) THEN
  yy = ai5 * theta(bc1mod,thbc1,wtmp) * nh3con
ELSE
  nh3con=0.001
END IF
IF (no2con > 0.001) THEN
