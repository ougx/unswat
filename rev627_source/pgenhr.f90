...
!! peak occur at random time
rn = aunif(rndseed(10,jj))
ihour = MIN(MAX(INT(rn*nstep) ,1),24)

rainsub(jj,:) = 0
rainsub(jj,ihour) = subp(jj)

RETURN
END SUBROUTINE pgenhr_pulse
